            ...
            <? endforeach; ?>
                ...
                <? foreach ($arResult["ITEMS"] as $key => $arItem)//prices
                {
                    ...
                    if (isset($arItem["PRICE"])):
                        ...
                        ?>
                        <div class="  filter__item bx-active">
                ...
                if ($arItem["DISPLAY_EXPANDED"] == "Y"):?>bx-active<? endif ?>">
                    ...
                    <a href="#" class="filter__item__title bx-filter-parameters-box-title"
                       ><!-- onclick="smartFilter.hideFilterProps(this)" -->
                        <span class="icon"></span> <span class="title-txt"><?= $arItem["NAME"] ?></span>
                    ...
                    <div  >
                            ...
                            ?>
                                ...
                                <ul class="filter__item__content">
                                    <?
                                    foreach ($arItem["VALUES"] as $val => $ar):?>
<!--                                        <li><label><input type="checkbox"><span class="checkbox__icon"></span>Инсульт</label></li>-->
                                        <li>
                                            <label data-role="label_<?= $ar["CONTROL_ID"] ?>"
...
<script type="text/javascript">
    ...
    // var filter__item = $('.filter__item');
    // filter__item.removeClass('active');
    // filter__item.addClass('activeTab');
    // var label = $('.filter__item__title');

    // label.click(function(event) {
    //     filter__item.removeClass('active');
    //     let target = event.target;
    //     let parent = $(target).parents('.filter__item');
    //     // filter__item.addClass('active');
    //     // parent.removeClass('active');
    //     parent.toggleClass('activeTab');
    // });
</script>